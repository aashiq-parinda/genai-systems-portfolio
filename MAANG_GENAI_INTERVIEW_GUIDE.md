...
| 🔬 **Applied AI Scientist** | Derive LoRA ($W_0 + \frac{\alpha}{r}BA$) and DPO implicit loss from scratch; explain why DPO drops the PPO reward model & critic. | $\mathcal{L}_{\text{DPO}} = -\log \sigma (\beta \log \frac{\pi_\theta}{\pi_{\text{ref}}})$ |
...
#### 🎯 Question Statement
"Design an enterprise documentation Q&A assistant over 1,000,000 technical docs. Must maintain a Time-To-First-Token (**TTFT < 250ms**) and Inter-Token Latency (**ITL < 25ms**) at 500 QPS."
